...
using volume = Jk.Obb2d;
using range = Jk.Range2d;
using aabb = Jk.Aabb2d;
...
namespace Jk {
	...
	public struct Obb2d : IJsonable {
		...
		public Obb2d(vector center, vector extents, vector ax, vector ay) {
			Center = center;
			Extents = extents;
			Ax = ax;
			Ay = ay;
