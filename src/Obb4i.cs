...
using volume = Jk.Obb4i;
using range = Jk.Range4i;
using aabb = Jk.Aabb4i;
...
namespace Jk {
	...
	public struct Obb4i : IJsonable {
		...
		public Obb4i(vector center, vector extents, vector ax, vector ay, vector az, vector aw) {
			Center = center;
			Extents = extents;
			Ax = ax;
			Ay = ay;
