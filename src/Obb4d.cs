...
using volume = Jk.Obb4d;
using range = Jk.Range4d;
using aabb = Jk.Aabb4d;
...
namespace Jk {
	...
	/// </summary>
	[XmlType("Jk.Obb4d")]
	[StructLayout(LayoutKind.Explicit, Pack = 8, Size = 192)]
	[Serializable]
	public struct Obb4d : IJsonable {
		[FieldOffset(0)]
